    ...
    return (
        <>
            <form className="flex justify-between w-full mt-[16px] items-center md:justify-between">
                ...
                <input className="bg-white outline-2 outline-[#5D688A] w-[120px] h-[28px] rounded-[20px] px-4 focus:outline-3 text-center text-[12px] mr-9" onChange={(e) => {setTitle(e.target.value)}}></input>
            </form>
        </>
    )
}
