    ...
    return (
        <>
            <form className="flex justify-between w-full mt-[16px] items-center md:justify-evenly">
                ...
                <input className="bg-white outline-2 outline-[#5D688A] w-[120px] h-[28px] rounded-[20px] px-4 focus:outline-3 text-center" onChange={(e) => {HandlingSlideNum(e.target.value)}}></input>
            </form>
